...
describe("structure pattern tests", () => {
  it("test_array_pattern_any", () => {
    const pattern = parsePattern("array");
  ...
  it("test_map_pattern_any", () => {
    const pattern = parsePattern("map");
  ...
  it("test_tagged_pattern_any", () => {
    const pattern = parsePattern("tagged");
  ...
  it("test_structure_pattern_display", () => {
    // Array patterns
    expect(display(parsePattern("[*]"))).toBe("[*]");
    ...
    // Tagged patterns
    expect(display(parsePattern("tagged"))).toBe("tagged");
  });
  ...
  it("test_nested_structure_patterns", () => {
    // Test nested arrays
    const nestedArrayPattern = parsePattern("[[number]]");
    ...
    // Test nested maps
    const nestedMapPattern = parsePattern('{"data": {"value": number}}');
  ...
  it("test_array_with_any_elements", () => {
    ...
    const pattern = parsePattern("[(*)*]"); // zero or more of anything
