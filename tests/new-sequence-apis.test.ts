...
describe("new sequence APIs", () => {
  ...
  it("test_structure_convenience_methods", () => {
    ...
    const taggedPaths = paths(taggedPattern, taggedCbor);
  ...
  it("test_empty_sequence_pattern", () => {
    ...
    // an empty sequence displays as `()`
    // so `parse(format(emptySequence()))` round-trips.
