...
describe("meta pattern tests", () => {
  ...
  it("test_and_pattern", () => {
    const pattern = parsePattern(">5 & <10");
  ...
  it("test_or_pattern", () => {
    const pattern = parsePattern('5 | "hello" | true');
  ...
  it("test_nested_meta_patterns", () => {
    ...
    const pattern = parsePattern('>5 & <10 | "hello"');
  ...
  it("test_capture_pattern_basic", () => {
    const pattern = parsePattern("@test(42)");
  ...
  it("test_capture_pattern_text", () => {
    const pattern = parsePattern('@name("hello")');
  ...
  it("test_capture_pattern_any", () => {
    const pattern = parsePattern("@anything(*)");
  ...
  it("test_capture_pattern_not_any", () => {
    const pattern = parsePattern("@nothing(!*)");
  ...
  it("test_search_pattern_basic", () => {
    const pattern = parsePattern("search(42)");
  ...
  it("test_search_pattern_text", () => {
    const pattern = parsePattern('search("hello")');
  ...
  it("test_search_pattern_any", () => {
    const pattern = parsePattern("search(*)");
...
[1, 2, 3]
  ...
  it("test_search_pattern_edge_cases", () => {
    const pattern = parsePattern("search(1)");
  ...
  it("test_capture_pattern_is_complex", () => {
    ...
    const complexDisplay = display(complex);
...
{"data": [{"values": [1, 2, 3]}, {"values": [4, 5, 6]}, {"other": "text"}], "meta": {"count": 5, "items": [7, 8, 9]}}
  ...
  it("test_search_pattern_with_structure_pattern", () => {
    ...
    const pattern = search(parsePattern("array"));
...
{"arrays": [[1, 2], [3, 4]], "not_array": 42}
  ...
  it("test_search_array_order", () => {
    ...
    const arrayPattern = parsePattern("search(array)");
...
[[1, 2, 3], [4, 5, 6]]
    ...
    const numberPattern = parsePattern("search(number)");
