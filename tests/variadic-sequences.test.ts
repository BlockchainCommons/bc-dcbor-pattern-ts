...
describe("comprehensive variadic sequences", () => {
  ...
  describe("Interval Quantifiers", () => {
    ...
    it("test_range_interval", () => {
      ...
      const pattern = parsePattern("[(*){2,4}]");
    ...
    it("test_maximum_interval", () => {
      ...
      const pattern = parsePattern("[(*){0,3}]");
  ...
  describe("Complex Scenarios", () => {
    it("test_quantifiers_with_captures", () => {
      ...
      const pattern = parsePattern("[(number)*, @item(text)]");
      ...
      const firstCapturePattern = parsePattern("[@first(number), (*)*]");
    ...
    it("test_multiple_quantifiers_in_pattern", () => {
      ...
      const pattern = parsePattern("[(number)*, (text)+]");
  ...
  describe("Type-specific pattern matching", () => {
    ...
    it("test_mixed_sequence_patterns", () => {
      ...
      const pattern = parsePattern("[number, text, bool]");
