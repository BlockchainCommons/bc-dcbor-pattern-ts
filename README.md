...
```typescript
import * as dcborpattern from "@blockchaincommons/dcbor-pattern";
```
...
`@blockchaincommons/dcbor-pattern` depends on `@blockchaincommons/components`, `@blockchaincommons/dcbor-compat`, `@blockchaincommons/dcbor-parse`, `@blockchaincommons/known-values` at runtime.
